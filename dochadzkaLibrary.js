...
const newMzdy = zaznam => {
    ...
    novyZaznam.field("Dochádzka").setAttr("odpracované", zaznam.field("Pracovná doba"));
    novyZaznam.field("Zamestnanec").setAttr("sadzba", zamestnanci[z].attr("hodinovka"));
